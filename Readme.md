...
This Android app is a Login + Greeting Application built using Kotlin and Android Studio.
It demonstrates the fundamentals of Android development, including:
...
2. Greeting Screen (SecondActivity)
